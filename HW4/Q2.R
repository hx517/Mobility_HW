...
#a).
# Reference Letters (book downloaded from Project Gutenberg)
ref=readLines("woshishei.txt",encoding="UTF-8")
ref=toupper(ref)
...
# MCM procedure with 26800 iterations
